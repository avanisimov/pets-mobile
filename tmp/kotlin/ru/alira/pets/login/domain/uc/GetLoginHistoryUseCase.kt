    ...
    override suspend operator fun invoke(): List<LoginMessageVO> {
        ...
        return listOf(
            ...
            LoginMessageVO(
                ...
                image = null,//ImageVO.Resource(MR.images.example_friends_search),
                source = LoginMessageSource.SYSTEM
            ),
            LoginMessageVO(
                "Общаться со знакомыми, делиться фотографиями и видео",
                image = null,//ImageVO.Resource(MR.images.example_pets_photos),
                source = LoginMessageSource.SYSTEM
            ),
            LoginMessageVO(
                "Узнавать новое про мир животных, делиться полезными советами",
                image = null,//ImageVO.Resource(MR.images.example_pets_news),
                source = LoginMessageSource.SYSTEM
            ),
            LoginMessageVO(
